 ...
 * permanent architectural regression test; a duplicate lives in the SEO package so either package alone enforces it.
 */
...
describe('planner pipeline ownership guard (ratified chain Marketing -> Content -> SEO -> Social)', () => {
  ...
  it('this package imports no forbidden planner in source (only SEO by reference)', () => {
