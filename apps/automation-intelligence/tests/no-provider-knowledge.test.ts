...
/**
 * The provider-neutrality invariant, enforced structurally: Automation Intelligence holds no vendor knowledge and names no
...
describe('no provider knowledge (provider neutrality)', () => {
