/**
 * Governance content hashing: a deterministic, dependency-free FNV-1a 32-bit hash of a canonical string, producing the
 * reproducible audit identifier of a governance decision. It is pure and total: the same content always yields the same
