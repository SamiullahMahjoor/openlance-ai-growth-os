...
/**
 * An automation-intelligence framing failure, distinguished by its stable `AUTOMATION.*` code (an unknown capability, a
 * blank objective or agent, a missing workflow reference, or an invalid knowledge reference). It is an infrastructure
